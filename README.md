...
## Data/Inputs
SCORES uses satellite data from MERRA-2 and ERA5, available on an hourly basis for a range of weather years. This data is available on the W: Drive, although you will need to request access
